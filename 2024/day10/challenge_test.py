...
class MyTestCase(unittest.TestCase):
    ...
    def test_star_1_snippet1(self):
        ...
        result: int = challenge.resolve_star1('snippet1_1.txt')
        self.assertEqual(2, result)

    def test_star_1_snippet2(self):
        challenge.max_rows = 7
        challenge.max_cols = 8
        result: int = challenge.resolve_star1('snippet1_2.txt')
        self.assertEqual(4, result)

    def test_star_1_snippet2(self):
        challenge.max_rows = 7
        challenge.max_cols = 8
        result: int = challenge.resolve_star1('snippet1_3.txt')
    ...
    def test_star_2_snippet1(self):
        challenge.max_rows = 7
        challenge.max_cols = 8
        result: int = challenge.resolve_star2('snippet2_4.txt')
        self.assertEqual(3, result)

    def test_star_2_snippet1(self):
        challenge.max_rows = 7
        challenge.max_cols = 8
        result: int = challenge.resolve_star2('snippet2_5.txt')
